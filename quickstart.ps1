...
Write-Host ""
Write-Host "[INFO] Downloading docker-compose.yml..."
...
Write-Host "[INFO] Starting Agent Catalog..."
docker compose up -d
...
Write-Host "[INFO] Creating Iceberg tables..."
...
if ($exitCode -eq "0") {
    ...
    Write-Host ""
    Write-Host "[ERROR] Table creation failed. Check logs:"
